...
const Header = ({car,removeFromCar,decreaseQuantity,incremenQuantity,clearCart,cartTotal}) => {
            ...
            <div className="carrito-container">
              <div className="carrito">
                ...
                <div id="carrito-content" className="carrito-content">
                  {car.length === 0 ? (<p className="text-center">El carrito está vacío</p> ) :
                  (     
                    <>
                    ...
                    <tbody>
                    {car.map(({id,name,image,price,quantity}) => (                      
                      <tr key={id}>
